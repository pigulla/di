...
import {
    ...
    NowPlaying,
    DigitallyImported,
    DigitallyImportedError,
} from '~src/infrastructure/di'

import {stub_config, stub_logger} from '~test/util'
...
describe('DigitallyImported', function () {
    ...
    it('should fail if there is no script tag', async function () {
        ...
        await expect(digitally_imported.load_app_data()).to.be.rejectedWith(
            DigitallyImportedError,
